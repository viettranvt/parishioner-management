...
func (biz *getListBusiness) GetList(ctx context.Context, params *common.Param) ([]parishioner_database.Model, error) {
	return biz.store.GetParishionerListHasPagination(ctx, params, false)
}
